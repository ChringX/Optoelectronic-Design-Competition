...
void motor_set_pwm(uint8_t motor, int32_t pid_out)
{
	...
	if (pid_out >= 0)
	{
		...
		switch (motor)
		{
			case 1: TIM2->CCR3 = 0; TIM2->CCR1 = ccr;	break;  //左
			case 2: TIM2->CCR4 = 0; TIM2->CCR2 = ccr;	break;  //右
	...
	else if (pid_out < 0)
	{
		...
		switch (motor)
		{
			case 1: TIM2->CCR1 = 0; TIM2->CCR3 = ccr;	break;  //左
			case 2: TIM2->CCR2 = 0; TIM2->CCR4 = ccr;   break; 	//右
